...
const imgHero = `${assetPathPrefix}/f93a7.png`;
const imgProject1 = `${assetPathPrefix}/26be1.png`;
const imgProject2 = `${assetPathPrefix}/aff26.png`;
const imgProject3 = `${assetPathPrefix}/f02c2.png`;
const imgProject4 = `${assetPathPrefix}/b5a11.png`;
const imgGitHub = `${assetPathPrefix}/fa4a1.png`;
const imgLinkedIn = `${assetPathPrefix}/e81e2.png`;
const imgInstagram = `${assetPathPrefix}/10513.png`;

// Icon SVGs
const imgArrowContainer = `${assetPathPrefix}/eaac1.svg`;
const imgLocationDot = `${assetPathPrefix}/e2cd4.svg`;
const imgCrossLg = `${assetPathPrefix}/d931f.svg`;
const imgCrossLgH = `${assetPathPrefix}/83c5a.svg`;
const imgCrossSmV = `${assetPathPrefix}/52a01.svg`;
const imgCrossSmH = `${assetPathPrefix}/2e06d.svg`;
const imgSwirl = `${assetPathPrefix}/faca0.svg`;
const imgArchIcon = `${assetPathPrefix}/7d854.svg`;
const imgCheckArrow = `${assetPathPrefix}/15f9c.svg`;
const imgCheckDb = `${assetPathPrefix}/b342d.svg`;
const imgCheckLock = `${assetPathPrefix}/5411b.svg`;
const imgCloudIcon = `${assetPathPrefix}/ff986.svg`;
const imgDockerIcon = `${assetPathPrefix}/8dace.svg`;
const imgCloudCheck = `${assetPathPrefix}/5c624.svg`;
const imgGhActions = `${assetPathPrefix}/5a745.svg`;
const imgVisualIcon = `${assetPathPrefix}/d1582.svg`;
const imgNextjsIcon = `${assetPathPrefix}/c70f5.svg`;
const imgFramerIcon = `${assetPathPrefix}/195e6.svg`;
const imgWcagIcon = `${assetPathPrefix}/5be86.svg`;
const imgSpinDecor = `${assetPathPrefix}/e9817.svg`;
const imgArrowRight = `${assetPathPrefix}/5e111.svg`;
const imgDiscoveryIcon = `${assetPathPrefix}/fb917.svg`;
const imgBackendIcon = `${assetPathPrefix}/9ad07.svg`;
const imgFrontendIcon = `${assetPathPrefix}/6d90c.svg`;
const imgTestingIcon = `${assetPathPrefix}/4553c.svg`;
const imgCheckGreen = `${assetPathPrefix}/54306.svg`;
...
function TechTable() {
  ...
  return (
    <div className="border-[3px] border-[#111] w-full">
      {rows.map((row, ri) => (
        <div key={ri} className="flex">
          {row.map((cell, ci) => (
            <div
              key={ci}
              className="flex-1 border-[3px] border-[#111] flex items-center justify-center py-[17px] px-4"
            >
              <span
        ...
        <ul className="flex flex-col gap-3" aria-label={`${title} capabilities`}>
          {items.map((item, i) => (
            <li
              ...
              style={{ background: bg === "bg-white" ? "#f4f0ea" : "white" }}
            >
...
function ProjectCard({
  ...
  return (
    <div className="project-card flex flex-col gap-8">
      <div
        className="border-[3px] border-[#111] overflow-hidden relative w-full"
      ...
      >
        ...
        <div className="img-overlay absolute inset-0 bg-[#111] opacity-10" />
...
export default function App() {
  useScrollReveal();
  return (
    <div className="bg-[#f4f0ea] w-full min-h-screen overflow-x-hidden" id="top">
      {/* Marquee keyframes */}
      <style>{`
        @keyframes marquee {
        ...
        /* Project image: grayscale → full colour on card hover */
        ...
        /* Image zoom + colour reveal */
        .project-img {
          transition: filter 0.4s ease, transform 0.5s cubic-bezier(.2,0,.1,1);
          filter: saturate(0);
        }
        .project-card:hover .project-img {
          filter: saturate(1);
      ...
      {/* ── HEADER ── */}
      <header
        className="bg-[#f4f0ea] border-b-[3px] border-[#111] flex items-center justify-between px-8 py-4 sticky top-0 z-50"
        style={{ boxShadow: "6px 6px 0px #111" }}
        role="banner"
      >
        <a
        ...
        <nav className="hidden md:flex gap-8 items-center" aria-label="Main navigation">
          {["Services", "Work", "Process", "About", "Contact"].map((link, i) => (
            <a
              ...
              className={`nav-link text-[16px] font-bold uppercase tracking-[-0.8px] ${i === 0 ? "text-[#fb51d6]" : "text-[#111] hover:text-[#fb51d6]"} transition-colors`}
              style={{ fontFamily: "'Space Grotesk', sans-serif" }}
            >
              {link}
            </a>
        ...
        <a
          ...
          className="btn-press bg-[#fb51d6] border-[3px] border-[#111] px-7 py-3 text-white font-bold uppercase text-[16px] tracking-[-0.8px]"
      ...
      {/* ── HERO ── */}
      <section className="flex flex-col lg:flex-row items-center gap-8 px-8 lg:px-12 py-24 max-w-[1280px] mx-auto relative">
        {/* Left */}
        <div className="flex-1 flex flex-col items-start z-10">
          <div data-reveal data-delay="100" className="flex flex-col gap-1 pb-8">
            <span
            ...
            <div className="inline-block" style={{ transform: "rotate(1deg)" }}>
              <div className="bg-white border-[3px] border-[#111] px-3 py-1 inline-block">
                <span
                  className="text-[#fb51d6] font-bold uppercase leading-[0.9]"
                  style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(44px, 10vw, 96px)", letterSpacing: "-2px" }}
                >
                  DEVELOPER
                </span>
          ...
          <a
            ...
            href="#work"
            className="btn-press bg-[#fb51d6] border-[3px] border-[#111] flex items-center gap-2 px-6 py-4 rounded-sm"
        ...
        {/* Right: portrait */}
        <div data-reveal="right" data-delay="200" className="flex-1 relative flex items-center justify-center pl-0 lg:pr-6 pt-8">
          ...
          >
            <div className="absolute inset-0" style={{ background: "linear-gradient(51deg, rgba(251,81,214,0.4) 0%, #f4f0ea 50%, rgba(144,168,237,0.4) 100%)", mixBlendMode: "multiply" }} />
            <div className="absolute inset-0 opacity-80" style={{ mixBlendMode: "luminosity" }}>
              <img alt="Portrait" className="w-full h-full object-cover" src={imgHero} />
            </div>
            <div className="absolute inset-[20%] bg-[#fb51d6] border-[3px] border-[#111] rounded-xl" style={{ mixBlendMode: "exclusion" }} />
      ...
      {/* ── ABOUT / SKILLS ── */}
      <section id="about" className="max-w-[1280px] mx-auto px-8 lg:px-12 py-24 flex flex-col lg:flex-row gap-16 items-start">
        {/* Skills grid */}
        ...
        <div data-reveal="right" data-delay="150" className="flex flex-col gap-8 flex-1 max-w-[600px]">
          ...
          <div className="flex flex-col gap-6">
            <div className="bg-[rgba(251,81,214,0.2)] px-2">
              <p
            ...
            <div className="border-l-[3px] border-[#fb51d6] pl-5">
              <p
                className="text-[#475569] text-[18px] leading-[28px]"
                style={{ fontFamily: "'DM Mono', monospace", fontWeight: 500 }}
              >
                {">"} Currently pursuing a BS in Computer Science at Virtual University of Pakistan, and building production sites at Zera Creative.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ── SERVICES ── */}
      <section id="services" className="max-w-[1280px] mx-auto px-8 lg:px-12 pb-20 relative">
        {/* Section header */}
        <div data-reveal className="flex flex-col gap-4 mb-10">
          ...
          <div>
            ...
            <p
              className="text-[#fb51d6] font-bold uppercase leading-[1.2]"
              style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(40px, 8vw, 96px)", letterSpacing: "clamp(-2px, -0.5vw, -5.12px)" }}
            >
              Excellence.
            </p>
        ...
        <div className="mt-10" style={{ transform: "rotate(0.5deg)" }}>
          <div
            className="bg-[#fb51d6] border-[3px] border-[#111] flex flex-col md:flex-row items-center justify-between px-7 py-8 gap-6"
            style={{ boxShadow: "8px 8px 0px #111" }}
          >
            <div className="flex items-center gap-4">
              <div className="bg-white border-2 border-[#111] rounded-full p-[10px] shrink-0">
                <span className="text-[#fb51d6] text-[24px] leading-none" style={{ fontFamily: "sans-serif" }}>⚡</span>
              </div>
              <span
            ...
            <div className="flex gap-4">
              <a
                href="mailto:sameeralifazal@gmail.com?subject=CV Request"
      ...
      {/* ── SELECTED PROJECTS ── */}
      <section id="work" className="max-w-[1280px] mx-auto px-8 lg:px-12 py-24">
        {/* Header */}
        <div data-reveal className="mb-16">
          ...
          >
            Selected<br />
            <span className="text-[#fb51d6]">Projects</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-24">
          ...
          <ProjectCard
            ...
            tags={[
              ...
              { text: "PHP", bg: "#90a8ed", rotate: "2deg" },
            ]}
            num="01"
            numColor="#fb51d6"
            title="Bookings Plugin"
            desc="Custom WordPress plugin for client booking management with email confirmations, calendar integration, and automated reminders—resulting in 50% reduction in booking management time."
          />
          </div>
          <div data-reveal data-delay="250">
          <ProjectCard
            image={imgProject2}
            tags={[{ text: "PHP", bg: "#fb51d6", color: "white", rotate: "5deg" }, { text: "MySQL", bg: "#111", color: "#f4f0ea", rotate: "-2deg" }]}
            num="02"
            numColor="#ffc900"
            title="Blog Backend API"
            desc="RESTful API built with PHP and MySQL using custom MVC architecture. JWT authentication, content versioning, and comprehensive documentation supporting multiple client applications."
          />
          </div>
          <div data-reveal data-delay="100">
          <ProjectCard
            image={imgProject3}
            tags={[{ text: "Shopify", bg: "#111", color: "#f4f0ea", rotate: "-1deg" }, { text: "Performance", bg: "#ffc900", rotate: "3deg" }]}
            num="03"
            numColor="#90a8ed"
            title="E-Commerce Speed"
            desc="Optimized a high-traffic e-commerce platform, reducing page load time by 40% through advanced caching strategies, image optimization, and database performance tuning."
          />
          </div>
          <div data-reveal data-delay="250">
          <ProjectCard
            image={imgProject4}
            tags={[
              { text: "WordPress", bg: "#ffc900", rotate: "1deg" },
              { text: "Shopify", bg: "#90a8ed", rotate: "-2deg" },
            ]}
            num="04"
            numColor="#fb51d6"
            title="Live Client Work"
            desc="Production sites including Zulfay Hair, Sprach Kompass, and Blun Care—each built with custom WordPress and Shopify solutions tailored to client needs."
          />
          </div>
        </div>
        ...
        <div
          ...
          style={{ boxShadow: "12px 12px 0px #fb51d6" }}
        >
          ...
          <div className="absolute right-0 bottom-0 top-0 w-32 opacity-10 z-0" style={{ background: "repeating-linear-gradient(45deg, #fb51d6 0, #fb51d6 5%, #111 5%, #111 10%)" }} />
          <a
            href={WA_LINK}
            target="_blank"
            rel="noopener noreferrer"
            className="btn-press bg-[#fb51d6] border-[3px] border-[#111] flex items-center gap-3 px-8 py-6 shrink-0 z-10"
      ...
      {/* ── PROCESS ── */}
      <section id="process" className="max-w-[1280px] mx-auto px-8 lg:px-12 py-24">
        {/* Header */}
        <div data-reveal className="flex flex-col gap-6 mb-12">
          ...
          <div>
            ...
            <p
              className="text-[#fb51d6] font-bold uppercase leading-[1]"
              style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(40px, 8vw, 96px)", letterSpacing: "clamp(-2px, -0.6vw, -6.4px)" }}
            >
              PROCESS
            </p>
            ...
            visual={
              <div style={{ transform: "rotate(2deg)" }}>
                <div
                  ...
                  style={{ boxShadow: "6px 6px 0px #111" }}
                >
                  <div className="absolute top-4 right-12 w-12 h-10 bg-[#fb51d6] border-2 border-[#111]" />
                ...
                >
                  <div className="flex flex-col gap-2 h-full p-4">
                    ...
                    <div className="flex gap-1 mt-auto">
                      ...
                      <div className="w-24 bg-[#fb51d6] h-2" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            visual={
              <div style={{ transform: "rotate(1deg)" }}>
                <div
                  ...
                  style={{ boxShadow: "6px 6px 0px #111" }}
                >
                  <div className="bg-[#f4f0ea] border-2 border-[#111] h-full p-1">
      ...
      >
        <div className="absolute top-10 left-10 size-32 bg-[rgba(251,81,214,0.2)] rounded-xl blur-[32px]" />
        ...
        <a
          ...
          rel="noopener noreferrer"
          data-reveal="scale"
          className="contact-cta text-[#111] font-bold uppercase text-center mb-16 leading-none hover:text-[#fb51d6] transition-colors"
          style={{
            fontFamily: "'Space Grotesk', sans-serif",
        ...
        <div className="relative mb-20">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-press text-[#111] pb-2 block hover:text-[#fb51d6] transition-colors"
            style={{ fontFamily: "'DM Mono', monospace", fontWeight: 500, fontSize: "clamp(18px, 3vw, 36px)" }}
          >
            sameeralifazal@gmail.com
          </a>
          <div className="absolute bottom-0 left-0 right-0 h-[6px] bg-[#fb51d6] border-[3px] border-[#111]" />
        </div>

        <div data-reveal data-delay="200" className="flex gap-6 items-center justify-center" role="list" aria-label="Social media links">
          {[
            { img: imgGitHub, alt: "GitHub" },
            { img: imgLinkedIn, alt: "LinkedIn" },
            { img: imgInstagram, alt: "Instagram" },
          ].map(({ img, alt }) => (
            <a
              key={alt}
              href="#"
              ...
              style={{ boxShadow: "4px 4px 0px #111" }}
              role="listitem"
              aria-label={`Visit Sameer Ali on ${alt}`}
            >
      ...
      <footer className="bg-[#111] border-t-[3px] border-[#111] px-12 py-10 flex flex-col md:flex-row items-center justify-between gap-6" role="contentinfo">
        <span
          className="text-[#f4f0ea] text-[16px] font-bold uppercase tracking-tight"
          style={{ fontFamily: "'Space Grotesk', sans-serif" }}
        >
        ...
        <nav className="flex gap-8" aria-label="Footer navigation">
          {[
            ...
            <a
              key={label}
              href={href}
              className="text-white text-[14px] uppercase hover:text-[#fb51d6] transition-colors"
              style={{ fontFamily: "'DM Mono', monospace" }}
              aria-label={label === "Email" ? "Send email to Sameer Ali" : `Visit Sameer Ali on ${label}`}
            >
              {label}
            </a>
          ))}
        ...
        <div style={{ transform: "rotate(2deg)" }}>
          <div
            className="bg-[#fb51d6] border-2 border-[#f4f0ea] px-[18px] py-[10px]"
            style={{ boxShadow: "4px 4px 0px rgba(251,81,214,0.3)" }}
          >
            <span
